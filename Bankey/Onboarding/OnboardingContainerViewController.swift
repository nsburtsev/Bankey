...
//  Bankey
//
//  Created by Нюргун on 12.12.2022.
//
...
extension OnboardingContainerViewController {
    ...
    @objc func backTapped(_ sender: UIButton) {
        guard let preciousVC = getPreviousViewController(from: currentVC) else { return }
        pageViewController.setViewControllers([preciousVC], direction: .reverse, animated: true, completion: nil)
    }
